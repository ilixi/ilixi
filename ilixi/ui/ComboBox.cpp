...
ComboBox::preferredSize() const
{
  ...
  return Size(
      s.width()
          + 2
              * std::max(stylist()->defaultParameter(StyleHint::BorderWidth),
                  stylist()->defaultParameter(StyleHint::ComboBoxRadius))
          + stylist()->defaultParameter(StyleHint::ComboBoxButtonWidth),
      s.height() + 2 * stylist()->defaultParameter(StyleHint::BorderWidth));
}
...
ComboBox::updateTextLayoutGeometry()
{
  ...
  _layout.setBounds(x, y,
      width() - x - stylist()->defaultParameter(StyleHint::ComboBoxButtonWidth),
